...
public class RoleUtil {
     ...
     */
    public static boolean hasAllowedRole(final Member member, final List<String> allowedRoleResolvables) {
        if (allowedRoleResolvables.contains("@everyone"))
            return true; // @everyone has permission, no need to do anything else
        else {
