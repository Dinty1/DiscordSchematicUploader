...
public class MessageUtil {
    ...
    public static EmbedBuilder createEmbedBuilder(final Color color, final User author, final String title) {
    ...
    public static boolean schematicAttached(final Message message) {
