...
public class PlayerJoinListener implements Listener {
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        if (event.getPlayer().hasPermission("discordschematicuploader.adminalerts") && DiscordSchematicUploader.getPlugin().isUpdateAvailable())
            event.getPlayer().sendMessage(ChatColor.GOLD + "An update for DiscordSchematicUploader is available! Get it here: https://modrinth.com/plugin/discordschematicuploader/versions");
    }
}
